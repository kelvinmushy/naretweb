...
class DepositeFumigationController extends Controller
{
    /**
    ...
    {
        //
        return view('fumigation.deposite.index');
    }
    ...
    public function check_account($id)
    {
        //
          if(request()->ajax()){
            ...
            $check1=$data[0]->account_balance;
            if($check=="Income"){
                return response()->json(['data' => $check,'data1'=>$check1]); 
            }
            //  
           }
    }
    ...
    public function apiDeposite1(){
        ...
        ->where('account_staff.status','=','active')
        // ->where('account_staff.staff_type','=','fumigation')
        ->get();
