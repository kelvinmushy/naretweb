...
class DepositeController extends Controller
{
    ...
    {
        //
        return view('casual.deposite.index');
    }
    ...
    public function apiDeposite(){
        $deposite =DB::table('deposite')
        ...
        ->get();
         return Datatables::of($deposite)
            ->addColumn('action', function($deposite){
                return '<a onclick="deleteData('.$deposite->id .')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> Delete</a>';
