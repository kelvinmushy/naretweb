...
class AsaliExpensiveController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        ->get(); 
        return view('expensive_asali.index',compact('account'));
    }
    ...
    public function asaliExpensiveApi() {
        $account = DB::table('account_staff')
         ->join('expensive_staff','account_staff.id','=','expensive_staff.account_id')
         ->where('expensive_staff.staff_type','=','asali')
