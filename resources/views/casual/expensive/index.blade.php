...
@section('content')
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Other Purchase</h3>

            <!-- <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Expensive</a> -->
        </div>
...
@section('bot')
    ...
    <script type="text/javascript">
        ...
        function editForm(id) {
            ...
            $('#form-account')[0].reset();
            $.ajax({
                url: "{{ url('expensive_staff') }}" + '/' + id + "/edit",
                type: "GET",
                dataType: "JSON",
                success: function(html) {
