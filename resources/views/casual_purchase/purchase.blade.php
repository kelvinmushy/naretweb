...
<html lang="en">
    ...
    <body>
      ...
      <center><p><strong>NARET FUMIGATION AND GENERAL CLEANNESS</strong>{{$date_invo}}-Purchase Invoice---{{$purchase_invoice[0]->purchase_invoice}}---</p></center>
                ...
                <tr>
                    ...
                    <td class="px-0">
                            ...
                            <strong>Invoice Number </strong>
                              ...
                              <p class="buyer-phone">
                              {{$purchase_invoice [0]->purchase_invoice}}
                                </p>
