...
<html lang="en">
    ...
    <div class="box" width="100%">
        ...
        <table class="table">
            <thead>
                <tr> <th scope="col" class="border-0 pl-0">Title</th>
            ...
            <tbody>
                ...
                <tr>
                    <td >
                      ...
                      <td class="text-right" >
                       <strong style="color:#4682B4"> {{number_format($staffing_invoice[0]->tax_inclusive,2)}}</strong>
                        </td>
                ...
                <tr>
                    <td >
                      ...
                      VAT(18%):
                        ...
                        <td class="text-right">
                        <strong style="color:#4682B4">{{number_format($staffing_invoice[0]->tax,2)}}</strong>
                        </td>
                    ...
                    <td>
                      ...
                      <td></td>
                       ...
                       WITH HOLDING TAX(5%)
                        ...
                        <td class="text-right">
                        <strong class='text-infor'>{{number_format($staffing_invoice[0]->withhold_amount1,2)}}</strong>
                        </td>
                    <td >
                ...
                <tr>
                    <td>
                      ...
                      <td></td>
                        ...
                        <td class="text-right">
                        <strong class='text-infor'>{{number_format($staffing_invoice[0]->discount1,2)}}</strong>
                        </td>
                    <td >
                ...
                <tr  style="border:0px">
                    ...
                    <td></td>
                       ...
                       TOTAL EXCLUSIVE OF VAT
                        ...
                        <td class="text-right">
                        <strong>{{number_format($staffing_invoice[0]->tax_exclusive,2)}}</strong>
                        </td>
                    <td>
                ...
                <tr style="border:0px">
                    <td class="pl-0">
                      ...
                      AMOUNT DUE
                        ...
                        <td class="text-right">
                        <!-- <strong  style="color:#B22222">{{$staffing_invoice[0]->currency}}:{{number_format($staffing_invoice[0]->amount_due1,2)}}</strong> -->

                        <strong  style="color:#B22222">{{$staffing_invoice[0]->currency}}:{{number_format($staffing_invoice[0]->tax_inclusive,2)}}</strong>
                        </td>
               ...
               <p>Account Name:<strong>{{$pay_method[1]->acc_name}}</strong></p>
                @foreach($pay_method as   $pay_method)
                <p>{{$pay_method->method}}:<strong>{{$pay_method->acc_number}}</strong></p>
                 @endforeach
                 <hr>
