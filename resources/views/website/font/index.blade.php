...
@section('content')
    <main class="main">
        ...
        <div class="hero-section hero-slider owl-carousel owl-theme">
            <div class="hero-single" style="background-image: url(assets/website/img/container/1.jpg)">
                <div class="container">
            ...
            <div class="hero-single" style="background-image: url(assets/website/img/container/2.jpg)">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-7 col-lg-7">
                            <div class="hero-content">
            ...
            <div class="hero-single" style="background-image: url(assets/website/img/container/7.jpg)">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-7 col-lg-7">
                            <div class="hero-content">
                            ...
                            <div class="about-list-wrapper">
                                <ul class="about-list list-unstyled">
                                    <li>
                                        ...
                                        <div class="text">
                                            <p>Naret company limited satisfies client freight forwarding customs,example
                                            <br>
            ...
            <div class="container">
                ...
                <div class="row popup-gallery">
                    <div class="col-lg-4 col-md-6">
                        <div class="cases-item">
                            <div class="cases-images">
                                <img class="img-fluid" style="height:200px" src="{{ asset('assets/website/img/service/cargoseparation.jpeg')}}" alt="">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="cases-item">
                            <div class="cases-images">
                                <img style="height:200px"  class="img-fluid" src="{{ asset('assets/website/img/work/3.jpeg')}}" alt="">
                                <div class="cases-hover">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="cases-item">
                            <div class="cases-images">
                                <img style="height:200px"  class="img-fluid" src="{{ asset('assets/website/img/work/glass.jpeg')}}" alt="">
                                <div class="cases-hover">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="cases-item">
                            <div class="cases-images">
                                <img style="height:200px" class="img-fluid" src="{{ asset('assets/website/img/work/window.jpeg')}}" alt="">
                                <div class="cases-hover">
