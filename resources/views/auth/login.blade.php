            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <div class="logo text-center"><img src="{{asset('assets2/img/furm.jpg')}}"  width="160" height="200"></div>
                    ...
                    <div class="right">
                        ...
                        <div class="content text">
                            <h1 class="heading">Naret Fumigation and General Cleanness </h1>
