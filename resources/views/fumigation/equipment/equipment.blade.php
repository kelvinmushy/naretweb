...
@section('content')
    <div class="box">
        ...
        <div class="box-header">
            <a onclick="addForm()" class="btn btn-primary" >Add Equipment</a>
    ...
    @include('fumigation.equipment.form')
        ...
        $(function(){
            $('#modal-form form').validator().on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
                    if (save_method == 'add') url = "{{ url('equipment') }}";
                    else url = "{{ url('equipment') . '/' }}" + id;
