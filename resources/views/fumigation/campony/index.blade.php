...
@section('content')
    ...
    @include('fumigation.campony.form')
        ...
        $(function(){
            $('#modal-form form').validator().on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
                    if (save_method == 'add') url = "{{ url('company_info1') }}";
                    else url = "{{ url('company_info1') . '/' }}" + id;
