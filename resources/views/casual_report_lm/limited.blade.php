...
<html lang="en">
    ...
    <body>
       ...
       <img src="assets2/img/logo.jpg" height="100%" width="100%" style="opacity: 0.05;"/>
        </div>
      <section>
      <div class="box">
      
      <center><p><strong>NARET COOMPANY LIMITED</strong> {{$date_invo}}-sales Invoice---{{$staffing_invoice[0]->invoice_number}}---</p></center>
