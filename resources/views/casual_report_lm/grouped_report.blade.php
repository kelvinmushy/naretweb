...
<html lang="en">
    ...
    <body>
      ...
      <center><p><strong>NARET COMPANY LIMITED</strong></p></center>
    ...
    <div class="box" width="100%">
        ...
        </h4> <p style="font-size:10px;font-weigth: 30px">of  <span style="color:blue; font-size:10px;font-weigth: 30px;">{{$staffing_invoice[0]->name}}</span></p>
  </div>
          </section>
